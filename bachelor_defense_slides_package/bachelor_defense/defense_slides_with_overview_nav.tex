...
% -----------------------------------------------------------------------------
\begin{frame}{Folding RNA: motifs}
  \centering
...
% -----------------------------------------------------------------------------
\begin{frame}{Folding RNA: representations}
  \centering
    ...
    \only<4>{
      \begin{minipage}{0.92\textwidth}
        ...
        \begin{itemize}
          ...
          \item report MCC
          \item report RNA-specific metrics: symmetry, sparsity, non-canonical ratio, min loop
                length
        \end{itemize}
      \end{minipage}
    }
...
\begin{frame}{RQ1: MCC and generalization gap}
  \vfill
  \centering
  \includegraphics[height=0.5\textwidth,keepaspectratio]{rq1mcc.png}\\[3pt]
  \vfill
